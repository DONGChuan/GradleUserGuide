...
* [Java 插件](the_java_plugin/README.md)
   ...
   * [使用资源集工作](the_java_plugin/java_plugin_working_with_source_sets.md)
       * [Source set properties](the_java_plugin/java_plugins_some_source_set_examples.md)
       * [Defining new source sets](the_java_plugin/java_plugin_defining_new_source_sets.md)
       * [Some source set examples](the_java_plugin/test_execution.md)
