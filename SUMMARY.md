...
* [命令行界面](shi-yong-gradle-gou-jian/command-line-interface.md)
  * [执行 tasks](shi-yong-gradle-gou-jian/command-line-interface/executing-tasks.md)
  * [常用 tasks](shi-yong-gradle-gou-jian/command-line-interface/common-tasks.md)
  * [项目报告](shi-yong-gradle-gou-jian/command-line-interface/project-reporting.md)
  ...
  * [Continuous Build](shi-yong-gradle-gou-jian/command-line-interface/continuous-build.md)
