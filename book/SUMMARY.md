...
* [使用 Gradle 命令行](using_the_gradle_command-line/README.md)
   ...
   * [获取构建信息](using_the_gradle_command-line/listing_tasks.md)
       ...
       * [Show task usage details](using_the_gradle_command-line/show_task_usage_details)
       * [Listing project dependencies](using_the_gradle_command-line/listing_project_dependencies)
       * [Getting the insight into a particular dependency](using_the_gradle_command-line/getting_the_insight_into_a_particular_dependency)
       * [Listing project properties](using_the_gradle_command-line/listing_project_properties)
       * [Profiling a build](using_the_gradle_command-line\profiling_a_build)
