...
* [构建脚本基础知识](build_script_basics/README.md)
   ...
   * [Dynamic tasks](build_script_basics/dynamic_tasks)
   * [Manipulating existing tasks](build_script_basics/manipulating_existing_tasks)
   * [Shortcut notations](build_script_basics/shortcut_notations)
   * [Extra task properties](build_script_basics/extra_task_properties)
   * [Using Ant Tasks](build_script_basics/using_ant_tasks)
   * [Using methods](build_script_basics/using_methods)
   * [Default tasks](build_script_basics/default_tasks)
