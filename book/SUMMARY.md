...
* [网页应用快速入门](web_application_quickstart/README.md)
   * [Building a WAR file](web_application_quickstart/building_a_war_file.md)
   * [Running your web application](web_application_quickstart/running_your_web_application.md)
* [Using the Gradle Command-Line](using_the_gradle_command-line/README.md)
   * [Executing multiple tasks](using_the_gradle_command-line/executing_multiple_tasks.md)
   * [Excluding tasks](using_the_gradle_command-line/excluding_tasks.md)
   * [Continuing the build when a failure occurs](using_the_gradle_command-line/continuing_the_build_when_a_failure_occurs.md)
